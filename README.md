...
- **Blog.** [https://angyujin.tistory.com/](https://angyujin.tistory.com/)
...
- 10초당 500건 이상의 데이터 수집 플랫폼 개발
- 70000건 이상의 결제 플랫폼 개발
...
- Kuber Config를 이용하여 MSA 각 모듈에 대한 설정자원 외부화 시스템 구축
- K8S 리소스 운영 및 관리
